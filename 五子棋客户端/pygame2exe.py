...
class BuildExe:
    def __init__(self):
        ...
        self.extra_datas = ["./image","./sound","./font"]
        # 额外需要的python库名
        self.extra_modules = []
        # 需要排除的python库
        self.exclude_modules = []
        # 额外需要排除的dll
        self.exclude_dll = ['OLEAUT.dll','USER32.dll','SHELL32.dll','ole32.dll','WINMM.DLL',\
                            'ADVAPI32.dll','msvcrt.dll','WS2_32.dll','GDI32.dll','VERSION.dll',\
                            'KERNEL32.dll']
        # 需要加入的py文件
        self.extra_scripts = []
